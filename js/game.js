...
// Modalità: ES module for easy wiring.
// Nota: progettato per essere standalone senza risorse esterne.
// Autore: generato da AI (MVP).
...
let state = {
  level: 1,
  timePerLevel: 60,     // T (fix)
  R0: 5,
  deltaR: 3,
  score: 0,
  disarmed: 0,
  required: 5,
  bombs: new Map(),    // id -> bomb object
  ...
  freezeUntil: 0,
  // New: explosions
  explosions: [],      // { x, y, radius, maxRadius, expansionSpeed, dom, active }
};
